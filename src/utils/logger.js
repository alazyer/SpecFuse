...
export const logger = {
  ...
  info(msg)    { console.log(`  ${ICONS.info}  ${chalk.white(msg)}`); },
  success(msg) { console.log(`  ${ICONS.success}  ${chalk.green(msg)}`); },
  warn(msg)    { console.warn(`  ${ICONS.warn}  ${chalk.yellow(msg)}`); },
  error(msg)   { console.error(`  ${ICONS.error}  ${chalk.red(msg)}`); },
  debug(msg)   { if (debugEnabled) console.log(`  ${ICONS.debug}  ${chalk.gray(msg)}`); },
  sync(msg)    { console.log(`  ${ICONS.sync}  ${chalk.cyan(msg)}`); },
  drift(msg)   { console.log(`  ${ICONS.drift}  ${chalk.magenta(msg)}`); },
  phase(msg)   { console.log(`  ${ICONS.phase}  ${chalk.yellowBright(msg)}`); },
