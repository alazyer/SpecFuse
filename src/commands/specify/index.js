...
export async function specifyInit(projectRoot, options = {}) {
  ...
  logger.info(
    `1. Edit ${chalk.cyan('.specfuse/constitution.md')} — add your own rules in the non-managed sections`,
  )
...
export async function specifyShow(projectRoot) {
  ...
  logger.info(
    `To update: edit ${chalk.cyan('.specfuse/constitution.md')} or run ${chalk.cyan('specfuse specify add <section>')}`,
  )
